const Clock = (function () {
  ...
  return {
    ...
    ui: function () {
      ...
      valentineifyBtn.addEventListener(
        "click",
        function (e) {
          e.preventDefault();
...
var Particle = function (canvas) {
  var range = (Math.random() * 180) / Math.PI, // random starting point
    ...
    size = Math.random() * 4; // random size of particle
...
var FPS = {
  ...
  update: function () {
    ...
    //   "FPS Average: " +
    //   Math.round((1000 * this.frames) / this.totalTime) +
    //   " Current: " +
    //   Math.round((1000 * this.updateFrames) / this.updateTime);
