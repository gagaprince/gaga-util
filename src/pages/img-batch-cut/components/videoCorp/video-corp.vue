<template>
  <div class="video-corp-container">
    ...
    <div
      v-if="videoSnapshot"
      :style="{
        width: videoInfo.showWidth + 'px',
        height: videoInfo.showHeight + 'px',
      }"
    >
      <VueCropper
        ref="imgcorp"
    ...
    <div v-if="!videoSnapshot" class="control-frame" @click="cutVideoSnapshot">
      <el-icon><Crop /></el-icon>
    </div>
    <div v-if="videoSnapshot" class="control-frame" @click="returnVideoScene">
...
<script>
import VueCropper from "../imgCorp/vue-cropper.vue";
